...
fun OverviewPage(
    ...
    // Tue May 20 10:34:42 GMT+06:00 2025 // TODO: How to extract day, month, year out of it

    Log.d("CurrentDate Info:", currentDate.toString())
    LaunchedEffect(currentDate) {
        val fetchedDay = dayViewModel.fetchDayByDateSuspend(currentDate)
        Log.d("LaunchedEffect: FetchedDay:", fetchedDay.toString())
        ...
        if (fetchedDay == null) {
            val newDay = Day(
                ...
                target = Nutriments(2200.0, 320.0, 52.0, 72.0), // TODO: From Settings-Page
                breakfast = emptyList(),
                lunch = emptyList(),
                dinner = emptyList(),
                snack = emptyList()
    ...
    Column(
        ...
        val defaultDate = LocalDate.parse("2023-07-02")
        ...
        Log.d("OverviewPage: CurrentDay:", currentDay.toString())
        DayOverview(
